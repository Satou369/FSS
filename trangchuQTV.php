...
<head>
	...
	<link rel="stylesheet" href="Strangchu.css">
</head>
<body>
    <div class="menu">
        <div class="profile">
	...
	<div class="main-contest">
		<div class="contest">
			<div class="main1"
				<li> Doanh thu <a href="baocaodoanhthu.php" target="blank"><i class="fa fa-play" aria-hidden="true" ></i></a></li>
			</div>
		</div>
		<div class ="dt2"></div>
		<div class="contest">
			<div class="main2"
				<li> Hàng trong kho <a href="qlkhohang.php"><i  class="fa fa-play" aria-hidden="true"></i></a></li>
			</div>
		</div>
	</div>
</body>
